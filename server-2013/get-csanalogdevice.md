...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398748(v=OCS.15)
ms:contentKeyID: 48276041
ms.date: 01/07/2017
...
Returns information about the analog devices you can manage by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network. Este cmdlet se presentó en Lync Server 2010.
...
Example 8 returns a collection of all the analog devices that have a contact object in the Telecommunications OU in Servicios de dominio de Active Directory. To do this, the **Get-CsAnalogDevice** cmdlet is called along with the OU parameter; the parameter value limits the returned objects to analog devices that have contacts objects in the OU with the distinguished name ou=Telecommunications,dc=litwareinc,dc=com.
