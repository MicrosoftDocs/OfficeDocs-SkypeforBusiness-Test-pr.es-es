...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204767(v=OCS.15)
ms:contentKeyID: 48274787
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Remove-CsPersistentChatComplianceConfiguration** cmdlet are not available in the Panel de control de Lync Server.
