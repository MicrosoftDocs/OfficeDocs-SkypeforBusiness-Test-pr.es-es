...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205084(v=OCS.15)
ms:contentKeyID: 48276026
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsFIPSConfiguration** cmdlet are not available in the Panel de control de Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for which the FIPS configuration settings are being modified. For example:</p>
