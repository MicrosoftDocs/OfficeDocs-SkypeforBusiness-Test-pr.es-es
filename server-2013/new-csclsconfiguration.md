...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ619177(v=OCS.15)
ms:contentKeyID: 49115281
ms.date: 01/07/2017
...
Creates a new collection of centralized logging configuration settings. Centralized logging provides a way for administrators to simultaneously enable or disable Lync Server 2013 tracing on multiple computers. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **New-CsCClsConfiguration** cmdlet are not available in the Panel de control de Lync Server.
...
<p>This parameter is intended for use with Skype Empresarial Online.</p></td>
</tr>
<tr class="odd">
