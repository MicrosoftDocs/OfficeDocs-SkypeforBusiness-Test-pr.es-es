...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205277(v=OCS.15)
ms:contentKeyID: 48276715
ms.date: 01/07/2017
...
Returns information about all the Lync Server 2013 meeting rooms configured for use in the organization. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Get-CsMeetingRoom** cmdlet are not available in the Panel de control de Lync Server.
