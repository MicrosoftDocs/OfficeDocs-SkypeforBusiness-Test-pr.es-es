...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398859(v=OCS.15)
ms:contentKeyID: 48276702
ms.date: 01/07/2017
...
Modifies the property values for one or more Edge Servers. Edge Servers are used to provide connectivity between your internal network and the Internet. Este cmdlet se presentó en Lync Server 2010.
...
The command shown in Example 1 modifies the internal and external SIP ports for the Servidor perimetral "EdgeServer:atl-edge-001.litwareinc.com".
...
<td><p>Port used for SIP communications between the Servidor perimetral and client devices. The initial value is set in Generador de topologías but can be changed by specifying a new value for this parameter.</p></td>
</tr>
<tr class="even">
...
<td><p>Optional</p></td>
<td><p>System.UInt16</p></td>
<td><p>Port used for Persistent Shared Object Model (PSOM) communications between the Servidor perimetral and client devices. The initial value is set in Generador de topologías but can be changed by specifying a new value for this parameter.</p></td>
</tr>
<tr class="even">
<td><p><em>DataPsomServerPort</em></p></td>
<td><p>Optional</p></td>
<td><p>System.UInt16</p></td>
<td><p>Port used for PSOM communications between the Servidor perimetral and other servers.</p></td>
</tr>
<tr class="odd">
...
<td><p>Service location of the Servidor perimetral to be modified. For example: -Identity &quot;EdgeServer:atl-edge-001.litwareinc.com&quot;.</p>
...
<td><p>Optional</p></td>
<td><p>System.UInt16</p></td>
<td><p>Port used for external media relay traffic using the Transmission Control Protocol (TCP). The default value is 444 if your Edge server has a single IP address. If your Edge server has multiple IP addresses then the default value is 443. These values are initially set in Generador de topologías but can be changed by specifying a new value for this parameter.</p></td>
</tr>
<tr class="odd">
...
<td><p>Service location of the Registrar to be associated with the Servidor perimetral. For example: -Registrar &quot;Registrar:atl-cs-001.litwareinc.com&quot;.</p></td>
</tr>
<tr class="odd">
