...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204962(v=OCS.15)
ms:contentKeyID: 48275487
ms.date: 01/07/2017
...
Returns information about the outbound calling number translation rules created for use in your organization. An outbound calling number translation rule converts the E.164 phone numbers used by Lync Server 2013 to a format that can be used by trunking peers that do not support E.164 numbers. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To view outbound calling number translation roles in the Panel de control de Lync Server, click Voice Routing and then click Trunk Configuration. Double-click appropriate entry in the Name column and then, in the Edit Trunk Configuration dialog box, scroll down to the section labeled Calling number translation rules.
