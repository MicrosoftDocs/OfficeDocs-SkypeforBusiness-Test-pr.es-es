...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205058(v=OCS.15)
ms:contentKeyID: 48275925
ms.date: 01/07/2017
...
Verifies that a user can connect to Exchange Unified Messaging and leave a voice mail message for another user. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the Test-CsExUMVoiceMail cmdlet are not available in the Panel de control de Lync Server.
