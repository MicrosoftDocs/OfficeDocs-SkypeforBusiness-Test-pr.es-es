...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398509(v=OCS.15)
ms:contentKeyID: 48275570
ms.date: 01/07/2017
...
Modifies an existing endpoint contact for a trusted application. Este cmdlet se presentó en Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet modifies an existing endpoint contact object in Servicios de dominio de Active Directory.
