...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205378(v=OCS.15)
ms:contentKeyID: 48277169
ms.date: 01/07/2017
...
Exports data from a Persistent Chat database. Este cmdlet se presentó en Lync Server 2013.
...
Panel de control de Lync Server: The functions carried out by the **Export-CsPersistentChatData** cmdlet are not available in the Panel de control de Lync Server.
