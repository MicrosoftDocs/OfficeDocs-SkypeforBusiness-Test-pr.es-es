...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398539(v=OCS.15)
ms:contentKeyID: 48275653
ms.date: 01/07/2017
...
Exports an Enterprise Voice Enhanced 9-1-1 (E9-1-1) configuration to a file in compressed format for backup purposes. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Returns the configuration as a byte array. The output of the command should be assigned to a variable for later import. (If you don’t assign the output to a variable, the byte array representing the configuration will scroll down your Shell de administración de Lync Server window.) You cannot specify both the AsBytes parameter and the FileName parameter; you can use only one or the other for each call to this cmdlet.</p></td>
</tr>
</tbody>
</table>
