...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425811(v=OCS.15)
ms:contentKeyID: 48274837
ms.date: 01/07/2017
...
Creates a new collection of static routing configuration settings. Este cmdlet se presentó en Lync Server 2010.
