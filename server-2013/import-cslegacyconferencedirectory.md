...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398418(v=OCS.15)
ms:contentKeyID: 48275421
ms.date: 01/07/2017
...
The **Import-CsLegacyConferenceDirectory** cmdlet enables you to import conference directories from Microsoft Office Communications Server 2007 R2 to Lync Server. This helps provide interoperability between Lync Server and Office Communications Server 2007 R2. Este cmdlet se presentó en Lync Server 2010.
