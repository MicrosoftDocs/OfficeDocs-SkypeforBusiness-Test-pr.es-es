...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204831(v=OCS.15)
ms:contentKeyID: 48275060
ms.date: 01/07/2017
...
Modifies the property values of an existing Lync Server 2013 meeting room. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. Este cmdlet se presentó en Lync Server 2013.
...
Panel de control de Lync Server: The functions carried out by the **Set-CsMeetingRoom** cmdlet are not available in the Panel de control de Lync Server.
