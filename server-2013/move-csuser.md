...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398528(v=OCS.15)
ms:contentKeyID: 48275608
ms.date: 01/07/2017
...
Moves one or more user accounts enabled for Lync Server to a new Registrar pool. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>URL for the hosted migration service used when moving a user to Skype Empresarial Online.</p></td>
</tr>
<tr class="even">
