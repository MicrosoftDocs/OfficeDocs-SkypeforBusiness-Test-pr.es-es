...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425933(v=OCS.15)
ms:contentKeyID: 48275113
ms.date: 01/07/2017
...
Removes the specified device update configuration settings. These settings help manage the Servicio web de actualización de dispositivos, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Phone Edition. Este cmdlet se presentó en Lync Server 2010.
