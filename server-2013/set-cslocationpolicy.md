...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412987(v=OCS.15)
ms:contentKeyID: 48277122
ms.date: 01/07/2017
...
Modifies an existing location policy. Este cmdlet se presentó en Lync Server 2010.
