...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Hh689989(v=OCS.15)
ms:contentKeyID: 48274261
ms.date: 01/07/2017
...
Verifies that authenticated users can use Lync Web App to join a Lync Server conference. Este cmdlet se presentó en Lync Server 2010.
