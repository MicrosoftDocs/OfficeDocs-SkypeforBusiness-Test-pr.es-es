...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205337(v=OCS.15)
ms:contentKeyID: 48276997
ms.date: 01/07/2017
...
Converts exported user data to the data format used by either Microsoft Lync Server 2010 or Lync Server 2013. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Convert-CsUserData** cmdlet are not available in the Panel de control de Lync Server.
