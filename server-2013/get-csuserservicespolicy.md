...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204838(v=OCS.15)
ms:contentKeyID: 48275045
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Get-CsUserServicesPolicy** cmdlet are not available in the Panel de control de Lync Server.
...
<td><p>When used, retrieves the user services policy for the specified Skype Empresarial Online tenant. For example:</p>
