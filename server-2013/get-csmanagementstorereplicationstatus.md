...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg399052(v=OCS.15)
ms:contentKeyID: 48277061
ms.date: 01/07/2017
...
Returns information about the Lync Server replication process; this includes information on whether replication is currently up to date for your Lync Server computers. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Returns additional information about the current status of the Almacén de administración central, including a list of active replicas and deleted replicas, as well as the location of the Active Master and the File Transfer Agent services.</p></td>
</tr>
<tr class="even">
