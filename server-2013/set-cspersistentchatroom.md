...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204801(v=OCS.15)
ms:contentKeyID: 48274918
ms.date: 01/07/2017
...
Modifies and existing Persistent Chat chat room. A chat room is a discussion forum that typically revolves around a specific topic. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To modify an existing Persistent Chat chat room using the Panel de control de Lync Server, click **Persistent Chat**, click **Room**, then double-click the chat room to be modified.
