...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412997(v=OCS.15)
ms:contentKeyID: 48277131
ms.date: 01/07/2017
...
Modifies one or more existing client personal identification number (PIN) policies. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Este cmdlet se presentó en Lync Server 2010.
