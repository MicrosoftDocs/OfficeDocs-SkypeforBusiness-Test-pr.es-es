...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205140(v=OCS.15)
ms:contentKeyID: 48276169
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To view Persistent Chat configuration information in the Panel de control de Lync Server, click **Persistent Chat** and then click **Persistent Chat Configuration**.
