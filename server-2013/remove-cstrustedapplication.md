...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398176(v=OCS.15)
ms:contentKeyID: 48274428
ms.date: 01/07/2017
...
Removes a trusted application from the associated trusted service. Este cmdlet se presentó en Lync Server 2010.
