...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398526(v=OCS.15)
ms:contentKeyID: 48275600
ms.date: 01/07/2017
...
Returns information about the Kerberos account assignments configured for use in the organization. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the Kerberos assignment data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
