...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ619181(v=OCS.15)
ms:contentKeyID: 49115291
ms.date: 01/07/2017
...
Determines whether or not a user can log on to Lync Server by using a certificate downloaded from the certificate provisioning service. Este cmdlet se presentó en Lync Server 2013. It replaces the **Test-CSClientAuth** cmdlet used in Lync Server 2010.
