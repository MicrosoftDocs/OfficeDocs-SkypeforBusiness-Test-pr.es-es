...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204771(v=OCS.15)
ms:contentKeyID: 48274807
ms.date: 01/07/2017
...
Returns information about the Persistent Chat categories in use in your organization. A Persistent Chat category represents a collection of Persistent Chat chat rooms. Each chat room must be associated with a category. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To view Persistent Chat categories in Panel de control de Lync Server, click **Persistent Chat** and then click **Category**.
