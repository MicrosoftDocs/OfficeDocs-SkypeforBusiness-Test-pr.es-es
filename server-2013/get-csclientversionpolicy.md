...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398957(v=OCS.15)
ms:contentKeyID: 48276856
ms.date: 01/07/2017
...
<td><p>Retrieves the client version policy data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
