...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398668(v=OCS.15)
ms:contentKeyID: 48275879
ms.date: 01/07/2017
...
Removes the specified collection of static routing configuration settings. Este cmdlet se presentó en Lync Server 2010.
