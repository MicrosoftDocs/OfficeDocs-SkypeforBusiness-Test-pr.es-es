...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398320(v=OCS.15)
ms:contentKeyID: 48275200
ms.date: 01/07/2017
...
Modifies a collection of Servicio web de actualización de dispositivos configuration settings. These settings are used to manage the Servicio web de actualización de dispositivos, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Server. Este cmdlet se presentó en Lync Server 2010.
