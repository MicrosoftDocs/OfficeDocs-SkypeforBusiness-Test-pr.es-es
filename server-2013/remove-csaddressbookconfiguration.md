...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398934(v=OCS.15)
ms:contentKeyID: 48276815
ms.date: 01/07/2017
...
Removes the specified collection of Address Book configuration settings. Este cmdlet se presentó en Lync Server 2010.
...
In addition, Address Book servers periodically generate index files that are downloaded to computers running Lync Server. When a user searches for contacts, he or she either search through these index files or search the Address Book index files stored in the Almacén de administración central.
