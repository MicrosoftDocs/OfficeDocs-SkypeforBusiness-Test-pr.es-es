...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398578(v=OCS.15)
ms:contentKeyID: 48275721
ms.date: 01/07/2017
...
Returns the dual-tone multifrequency (DTMF) signaling settings used for dial-in conferencing. DTMF enables users who dial in to a conference to control conference settings (such as muting and unmuting themselves or locking and unlocking the conference) by using the keypad on their telephone. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the DTMF configuration data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
