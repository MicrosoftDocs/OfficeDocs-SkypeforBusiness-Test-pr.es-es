...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398818(v=OCS.15)
ms:contentKeyID: 48276631
ms.date: 01/07/2017
...
Creates a new dial-in conferencing access number. Dial-in conferencing provides a way for users to use a "regular" telephone, cell phone or other device on the public switched telephone network (PSTN) to join the audio portion of a conference. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for which the new dial-in conferencing access number is being created. For example:</p>
