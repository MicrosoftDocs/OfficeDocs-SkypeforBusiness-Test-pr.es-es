...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398759(v=OCS.15)
ms:contentKeyID: 48276068
ms.date: 01/07/2017
...
Modifies one or more of the Web Server services used by Lync Server. Este cmdlet se presentó en Lync Server 2010.
