...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398733(v=OCS.15)
ms:contentKeyID: 48276004
ms.date: 01/07/2017
...
Creates new diagnostic configuration settings. Diagnostic configuration settings are used to determine whether traffic to or from a given domain or Uniform Resource Identifier (URI) is recorded in your Lync Server log files. Este cmdlet se presentó en Lync Server 2010.
