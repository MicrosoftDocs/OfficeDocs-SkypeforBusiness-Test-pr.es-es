...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425902(v=OCS.15)
ms:contentKeyID: 48275054
ms.date: 01/07/2017
...
Creates a new simple URL entry, an element needed when creating a simple URL. Simple URLs make it easier for users to join meetings and conferences, and also make it easier for Administrators to log on to the Panel de control de Lync Server. Este cmdlet se presentó en Lync Server 2010.
