...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204833(v=OCS.15)
ms:contentKeyID: 48275023
ms.date: 01/07/2017
...
Modifies a presence provider configured for use in the organization. Presence providers represent the PresenceProviders property of a collection of user services configuration settings. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsPresenceProvider** cmdlet are not available in the Panel de control de Lync Server.
