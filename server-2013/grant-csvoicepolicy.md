...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398828(v=OCS.15)
ms:contentKeyID: 48276647
ms.date: 01/07/2017
...
Assigns a voice policy to one or more users or groups. Este cmdlet se presentó en Lync Server 2010.
