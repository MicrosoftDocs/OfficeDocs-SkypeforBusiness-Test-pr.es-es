...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425875(v=OCS.15)
ms:contentKeyID: 48274972
ms.date: 01/07/2017
...
<td><p>Retrieves the meeting configuration data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
<tr class="even">
