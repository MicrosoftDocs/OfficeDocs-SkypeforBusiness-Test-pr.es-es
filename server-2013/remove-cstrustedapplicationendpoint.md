...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398837(v=OCS.15)
ms:contentKeyID: 48276666
ms.date: 01/07/2017
...
Removes a trusted application endpoint. Este cmdlet se presentó en Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet removes an existing endpoint contact object from Servicios de dominio de Active Directory.
