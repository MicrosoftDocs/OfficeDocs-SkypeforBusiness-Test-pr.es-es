...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412903(v=OCS.15)
ms:contentKeyID: 48276470
ms.date: 01/07/2017
...
Assigns a client version policy at the global, site, service, or per-user scope. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. Este cmdlet se presentó en Lync Server 2010.
