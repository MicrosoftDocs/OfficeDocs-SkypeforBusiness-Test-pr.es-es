...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg399040(v=OCS.15)
ms:contentKeyID: 48277027
ms.date: 01/07/2017
...
Creates a new Response Group time range. Time ranges are used by the Aplicación de grupo de respuesta to specify opening and closing times for a business day. For example, if your help desk agents are available only from 12:00 P.M. to 5:00 P.M. on Sundays, then you would create a time range for Sunday that had an opening time of 12:00 P.M. and a closing time of 5:00 P.M. Este cmdlet se presentó en Lync Server 2010.
