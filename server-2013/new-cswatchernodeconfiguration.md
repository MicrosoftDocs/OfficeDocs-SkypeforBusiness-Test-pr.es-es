...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205254(v=OCS.15)
ms:contentKeyID: 48276640
ms.date: 04/05/2017
...
**Panel de control de Lync Server:** The functions carried out by the **New-CsWatcherNodeConfiguration** cmdlet are not available in the Panel de control de Lync Server.
