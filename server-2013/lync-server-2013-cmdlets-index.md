---
title: Índice de cmdlets de Lync Server 2013
TOCTitle: Índice de cmdlets de Lync Server 2013
ms:assetid: cd37aba7-3d27-4db9-b69f-3a6da1fb4b4a
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398867(v=OCS.15)
ms:contentKeyID: 48276711
ms.date: 01/07/2017
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Índice de cmdlets de Lync Server 2013

 

_**Última modificación del tema:** 2016-12-08_

Microsoft Lync Server 2013 se suministra con más de 700 cmdlets para que los administradores puedan administrar Lync Server 2013 desde la línea de comandos. Por lo general, los cmdlets de Lync Server se usan con Shell de administración de Lync Server. Una forma de usar Shell de administración de Lync Server es iniciar sesión en un equipo que ejecuta un rol del servidor o un servicio de Lync Server y hacer clic sucesivamente en **Inicio**, **Todos los programas**, **Microsoft Lync Server 2013** y **Shell de administración de Lync Server**. Una vez abierto el Shell de administración, si desea obtener ayuda sobre un cmdlet directamente desde la línea de comandos, escriba un comando similar al siguiente:

    Get-Help New-CsVoicePolicy -Full

El comando anterior recupera toda la ayuda disponible para el cmdlet **New-CsVoicePolicy**. Si desea ver la ayuda de otro cmdlet, cambie **New-CsVoicePolicy** por el nombre del cmdlet cuya información de ayuda desea recuperar.

Para obtener una lista de todos los cmdlets disponibles para administrar Lync Server, escriba lo siguiente en el símbolo del sistema de Shell de administración de Lync Server:

    Get-Command * -Module Lync -CommandType cmdlet

Para más información sobre el uso de Shell de administración de Lync Server, consulte el blog de Lync Server Windows PowerShell en [http://go.microsoft.com/fwlink/p/?linkId=203150\&clcid=0xC0A](http://go.microsoft.com/fwlink/p/?linkid=203150%26clcid=0xc0a).

## Cmdlets de Lync Server 2013

A continuación se presenta una lista de los cmdlets que se suministran con Lync Server 2013:
