...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205192(v=OCS.15)
ms:contentKeyID: 48276433
ms.date: 01/07/2017
...
Modifies an existing Persistent Chat policy. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To modify an existing Persistent Chat policy using the Panel de control de Lync Server, click **Persistent Chat**, click **Persistent Chat Policy**, then double-click the policy to be modified.
