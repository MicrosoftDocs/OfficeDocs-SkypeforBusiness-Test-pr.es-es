...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204889(v=OCS.15)
ms:contentKeyID: 48275196
ms.date: 01/07/2017
...
Moves a Lync Server 2013 meeting room object from one Registrar pool to another. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. Este cmdlet se presentó en Lync Server 2013.
...
Panel de control de Lync Server: The functions carried out by the **Move-CsMeetingRoom** cmdlet are not available in the Panel de control de Lync Server.
