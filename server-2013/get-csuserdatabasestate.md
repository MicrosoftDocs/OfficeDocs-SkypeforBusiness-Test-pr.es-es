...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398831(v=OCS.15)
ms:contentKeyID: 48276653
ms.date: 01/07/2017
...
Returns information about the online status (True or False) of one or more Lync Server user databases. Este cmdlet se presentó en Lync Server 2010.
