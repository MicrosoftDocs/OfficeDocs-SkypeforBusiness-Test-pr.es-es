...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205330(v=OCS.15)
ms:contentKeyID: 48276937
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To create a new collection of Persistent Chat configuration settings using the Panel de control de Lync Server, click **Persistent Chat**, click **Persistent Chat Configuration**, click **New**, and then click either **Site configuration** or **Pool configuration**.
