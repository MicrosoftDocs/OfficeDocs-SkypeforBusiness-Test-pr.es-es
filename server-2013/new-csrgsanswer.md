...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412812(v=OCS.15)
ms:contentKeyID: 48276328
ms.date: 01/07/2017
...
Creates a new Response Group answer. Response Group answers are used to associate a caller response with the appropriate action. Este cmdlet se presentó en Lync Server 2010.
