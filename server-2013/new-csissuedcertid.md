...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425814(v=OCS.15)
ms:contentKeyID: 48274845
ms.date: 01/07/2017
...
Enables you to assign an existing certificate to a SipProxy.TLS object. In turn, that object can be used configure a static route to use Transport Layer Security (TLS) as its transport protocol. Este cmdlet se presentó en Lync Server 2010.
