...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413035(v=OCS.15)
ms:contentKeyID: 48277213
ms.date: 01/07/2017
...
Retrieves information about one or more trusted application endpoints. Este cmdlet se presentó en Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet retrieves one or more existing endpoint contact objects in Servicios de dominio de Active Directory.
