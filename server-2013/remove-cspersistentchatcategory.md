...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204660(v=OCS.15)
ms:contentKeyID: 48274370
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To remove a Persistent Chat category using the Panel de control de Lync Server, click **Persistent Chat** and then click **Category**. Select the category to be removed, click **Edit** and then click **Delete**.
