...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398463(v=OCS.15)
ms:contentKeyID: 48275489
ms.date: 01/07/2017
...
Returns information about the presence policies configured for use in your organization. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the presence policy data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
