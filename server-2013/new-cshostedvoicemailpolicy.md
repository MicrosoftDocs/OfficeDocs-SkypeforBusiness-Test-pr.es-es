...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398653(v=OCS.15)
ms:contentKeyID: 48275846
ms.date: 01/07/2017
...
Creates a new hosted voice mail policy. Este cmdlet se presentó en Lync Server 2010.
...
This cmdlet creates a policy that configures a user account enabled for Lync Server or Office Communications Server to use an Mensajería unificada de Exchange (UM) hosted voice mail service. The policy determines how to route unanswered calls to the user to a hosted Mensajería unificada de Exchange service.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for which the new hosted voicemail policy is being created. For example:</p>
