...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398573(v=OCS.15)
ms:contentKeyID: 48275689
ms.date: 01/07/2017
...
Removes settings that provide public switched telephone network (PSTN) phone numbers to access Mensajería unificada de Exchange Subscriber Access and Auto Attendant features. Este cmdlet se presentó en Lync Server 2010.
