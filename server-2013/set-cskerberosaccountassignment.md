...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398232(v=OCS.15)
ms:contentKeyID: 48274544
ms.date: 01/07/2017
...
Associates a Kerberos account, which is used for IIS Internet Information Services (IIS) authentication, with a site. Este cmdlet se presentó en Lync Server 2010.
