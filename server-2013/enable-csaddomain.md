...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412764(v=OCS.15)
ms:contentKeyID: 48276259
ms.date: 01/07/2017
...
Modifies the security settings on the universal groups created during forest preparation. These modifications provide the permissions needed to host and manage users enabled for Lync Server within the domain. Este cmdlet se presentó en Lync Server 2010.
