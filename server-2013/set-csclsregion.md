...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204746(v=OCS.15)
ms:contentKeyID: 48274704
ms.date: 01/07/2017
...
Modifies an existing centralized logging configuration region. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsClsRegion** cmdlet are not available in the Panel de control de Lync Server.
