...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412766(v=OCS.15)
ms:contentKeyID: 48276260
ms.date: 01/07/2017
...
Removes an existing Lync Server announcement. Announcements are played when users dial a valid but unassigned phone number. An announcement can be a message (such as "This number is temporarily out of service") or a busy signal. Este cmdlet se presentó en Lync Server 2010.
...
<p>- Enter the Identity of the Servicio de aplicaciones for the announcements you want to remove. This will remove all announcements configured with the given service Identity. For example, ApplicationServer:Redmond.litwareinc.com.</p>
