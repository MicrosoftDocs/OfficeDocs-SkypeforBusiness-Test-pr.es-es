...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204904(v=OCS.15)
ms:contentKeyID: 48275298
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the Get-CsFIPSConfiguration cmdlet are not available in the Panel de control de Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account whose FIPS configuration settings are to be retrieved.</p>
<p>For example:</p>
