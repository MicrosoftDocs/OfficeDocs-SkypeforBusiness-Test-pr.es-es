...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204784(v=OCS.15)
ms:contentKeyID: 48274808
ms.date: 01/07/2017
...
Verifies that a test user can connect to Exchange Unified Messaging. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Test-CsExUMConnectivity** cmdlet are not available in the Panel de control de Lync Server.
