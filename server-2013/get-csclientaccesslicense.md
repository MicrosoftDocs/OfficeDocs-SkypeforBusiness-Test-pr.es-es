...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204853(v=OCS.15)
ms:contentKeyID: 48275053
ms.date: 01/07/2017
...
Returns information about client license usage in your organization. Este cmdlet se presentó en Lync Server 2013.
...
> [!NOTE]
> For more information, and for ways to work around these issues, see the <A href="lync-server-2013-release-notes.md">Notas de la versión de Lync Server 2013</A>.
...
**Panel de control de Lync Server:** The functions carried out by the **Get-CsClientAccessLicense** cmdlet are not available in the Panel de control de Lync Server.
