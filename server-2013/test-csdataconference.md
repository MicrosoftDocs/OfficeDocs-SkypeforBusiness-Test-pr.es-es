...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205219(v=OCS.15)
ms:contentKeyID: 48276525
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Test-CsDataConference** cmdlet are not available in the Panel de control de Lync Server.
