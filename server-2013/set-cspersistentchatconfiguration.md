...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205122(v=OCS.15)
ms:contentKeyID: 48276098
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To modify an existing collection of Persistent Chat configuration settings using the Panel de control de Lync Server, click **Persistent Chat**, click **Persistent Chat Configuration**, then double-click the collection to be modified.
