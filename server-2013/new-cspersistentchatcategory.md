...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204803(v=OCS.15)
ms:contentKeyID: 48274923
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To create a new Persistent Chat category using the Panel de control de Lync Server, click **Persistent Chat**, click **Category**, and then click **New**.
