...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412937(v=OCS.15)
ms:contentKeyID: 48276560
ms.date: 01/07/2017
...
Creates a new analog device that can be managed by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network (PSTN). Este cmdlet se presentó en Lync Server 2010.
