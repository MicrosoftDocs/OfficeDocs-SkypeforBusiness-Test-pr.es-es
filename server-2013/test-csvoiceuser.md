...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413013(v=OCS.15)
ms:contentKeyID: 48277152
ms.date: 01/07/2017
...
Identifies the route that a phone call from a given user would take to be completed based on voice rules, routes, and policies. Este cmdlet se presentó en Lync Server 2010.
