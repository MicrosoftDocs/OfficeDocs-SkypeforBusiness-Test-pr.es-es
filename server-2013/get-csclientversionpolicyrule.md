...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413048(v=OCS.15)
ms:contentKeyID: 48277242
ms.date: 01/07/2017
...
Returns the client version policy rules configured for use in your organization. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the client version policy rule data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
