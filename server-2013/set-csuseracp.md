...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413018(v=OCS.15)
ms:contentKeyID: 48277151
ms.date: 01/07/2017
...
Adds a new audio conferencing provider to a user or group of users, or modifies an existing audio conferencing provider already assigned to a user. Este cmdlet se presentó en Lync Server 2010.
