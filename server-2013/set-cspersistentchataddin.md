...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204721(v=OCS.15)
ms:contentKeyID: 48274598
ms.date: 01/07/2017
...
Modifies an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To modify an existing Persistent Chat add-in using the Panel de control de Lync Server, click **Persistent Chat**, click **Add-in**, then double-click the add-in to be modified.
