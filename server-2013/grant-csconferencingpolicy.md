...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425937(v=OCS.15)
ms:contentKeyID: 48275120
ms.date: 01/07/2017
...
Assigns a conferencing policy at the per-user scope. Conferencing policies determine the features and capabilities that can be used in a conference. This includes everything from whether or not the meeting can include IP audio and video to the maximum number of people who can attend a meeting. Este cmdlet se presentó en Lync Server 2010.
