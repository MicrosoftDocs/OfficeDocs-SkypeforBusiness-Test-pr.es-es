...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412968(v=OCS.15)
ms:contentKeyID: 48276595
ms.date: 01/07/2017
...
Moves an existing conference directory from one pool to another. Conference directories are used to help dial-in conferencing users locate conference information. Este cmdlet se presentó en Lync Server 2010.
