...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412957(v=OCS.15)
ms:contentKeyID: 48276578
ms.date: 01/07/2017
...
Retrieves a test scenario you can use to test phone numbers against specified routes and rules. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the voice test configuration from the local replica of the Almacén de administración central, rather than the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
