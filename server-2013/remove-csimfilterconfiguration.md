...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398171(v=OCS.15)
ms:contentKeyID: 48274409
ms.date: 01/07/2017
...
Removes the specified instant messaging (IM) filter configuration. (IM filter settings are used to prevent users from sending instant messages that contain hyperlinks.) Este cmdlet se presentó en Lync Server 2010.
