...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412932(v=OCS.15)
ms:contentKeyID: 48276537
ms.date: 01/07/2017
...
Removes a SIP response code translation rule. These rules enable administrators to map SIP response codes with values between 400 and 699 to the values used by Lync Server. Este cmdlet se presentó en Lync Server 2010.
