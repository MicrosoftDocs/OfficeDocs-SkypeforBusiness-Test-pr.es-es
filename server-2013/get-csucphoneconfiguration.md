...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398070(v=OCS.15)
ms:contentKeyID: 48274232
ms.date: 01/07/2017
...
Returns information regarding management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the UC phone configuration data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
