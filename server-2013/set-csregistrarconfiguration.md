...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398764(v=OCS.15)
ms:contentKeyID: 48276078
ms.date: 01/07/2017
...
Modifies the property values in an existing collection of Registrar configuration settings. Registrars are used to authenticate logon requests and to maintain information about user status and availability. Este cmdlet se presentó en Lync Server 2010.
