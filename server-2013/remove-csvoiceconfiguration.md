...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398804(v=OCS.15)
ms:contentKeyID: 48276217
ms.date: 01/07/2017
...
Resets the voice configuration to its default values. Este cmdlet se presentó en Lync Server 2010.
