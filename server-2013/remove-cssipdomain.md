...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398865(v=OCS.15)
ms:contentKeyID: 48276685
ms.date: 01/07/2017
...
Removes a SIP domain previously configured for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Este cmdlet se presentó en Lync Server 2010.
