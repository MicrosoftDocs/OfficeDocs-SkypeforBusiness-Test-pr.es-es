...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398325(v=OCS.15)
ms:contentKeyID: 48275253
ms.date: 01/07/2017
...
Creates a new collection of QoE (Quality of Experience) settings. Este cmdlet se presentó en Lync Server 2010.
...
<p>Note that even if EnableQoE is set to True, QoE data will not be collected unless a Servidor de supervisión has been deployed and associated with a Registrar pool.</p>
<p>Default: True</p></td>
</tr>
<tr class="even">
