...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205227(v=OCS.15)
ms:contentKeyID: 48276533
ms.date: 01/07/2017
...
Tests the ability of a pair of users to take part in an application sharing conference. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the Test-CsASConference cmdlet are not available in the Panel de control de Lync Server.
