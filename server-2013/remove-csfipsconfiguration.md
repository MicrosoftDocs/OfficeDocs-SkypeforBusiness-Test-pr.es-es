...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205201(v=OCS.15)
ms:contentKeyID: 48276466
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the Remove-CsFIPSConfiguration cmdlet are not available in the Panel de control de Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for the FIPS configuration settings being deleted. For example:</p>
