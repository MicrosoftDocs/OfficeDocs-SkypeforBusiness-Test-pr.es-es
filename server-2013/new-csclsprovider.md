...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ619187(v=OCS.15)
ms:contentKeyID: 49115303
ms.date: 01/07/2017
...
Creates a new centralized logging trace provider. Trace providers are application components that generate trace messages or trace events useful in troubleshooting problems with Lync Server. Este cmdlet se presentó en Lync Server 2013.
...
Panel de control de Lync Server: The functions carried out by the **New-CsClsProvider** cmdlet are not available in the Panel de control de Lync Server.
