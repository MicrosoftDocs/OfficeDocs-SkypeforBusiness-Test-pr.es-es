...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398132(v=OCS.15)
ms:contentKeyID: 48274331
ms.date: 01/07/2017
...
Returns information about Address Book configuration settings. Este cmdlet se presentó en Lync Server 2010.
...
Address Book servers are intermediaries between Servicios de dominio de Active Directory and Lync Server. The Address Book server ensures that the user information stored in Lync Server is in synch with the user information stored in Active Directory. This is done by periodically synching Address Book files with information stored in the Base de datos de usuarios.
...
<td><p>Retrieves the Address Book configuration data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
