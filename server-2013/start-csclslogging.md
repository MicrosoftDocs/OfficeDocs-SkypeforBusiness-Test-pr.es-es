...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ619190(v=OCS.15)
ms:contentKeyID: 49129319
ms.date: 01/07/2017
...
Starts the specified scenario centralized logging service scenario. Centralized logging provides a way for administrators to simultaneously enable or disable Lync Server 2013 tracing on multiple computers. Este cmdlet se presentó en Lync Server 2013.
