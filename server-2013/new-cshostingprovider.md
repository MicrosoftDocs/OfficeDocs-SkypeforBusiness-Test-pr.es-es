...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398490(v=OCS.15)
ms:contentKeyID: 48275527
ms.date: 01/07/2017
...
Note, too that you cannot federate with a hosting provider if your Servidores perimetrales are configured to use default routing rather than Domain Name System (DNS) server routing.
