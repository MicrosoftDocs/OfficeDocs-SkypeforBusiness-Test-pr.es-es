...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205414(v=OCS.15)
ms:contentKeyID: 48277255
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsUserServicesPolicy** cmdlet are not available in the Panel de control de Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for which the user services policy being modified. For example:</p>
