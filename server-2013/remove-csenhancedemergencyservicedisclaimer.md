...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425810(v=OCS.15)
ms:contentKeyID: 48274835
ms.date: 01/07/2017
...
Removes the disclaimer text that is used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. Este cmdlet se presentó en Lync Server 2010.
