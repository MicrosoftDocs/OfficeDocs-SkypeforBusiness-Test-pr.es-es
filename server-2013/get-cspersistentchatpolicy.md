...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204673(v=OCS.15)
ms:contentKeyID: 48274444
ms.date: 01/07/2017
...
Returns information about the Persistent Chat policies configured for use in your organization. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To view Persistent Chat policy information in the Panel de control de Lync Server, click **Persistent Chat** and then click **Persistent Chat Policy**.
