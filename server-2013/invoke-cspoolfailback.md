...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204873(v=OCS.15)
ms:contentKeyID: 48275191
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Invoke-CsPoolFailback** cmdlet are not available in the Panel de control de Lync Server.
