...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398484(v=OCS.15)
ms:contentKeyID: 48275553
ms.date: 01/07/2017
...
Modifies an existing set of privacy configuration settings. Privacy configuration settings help determine how much information users make available to other users. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for the privacy configuration settings being modified. For example:</p>
