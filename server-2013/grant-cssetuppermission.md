...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398569(v=OCS.15)
ms:contentKeyID: 48275684
ms.date: 01/07/2017
...
Grants Lync Server setup permissions on an Active Directory organizational unit (OU). Este cmdlet se presentó en Lync Server 2010.
