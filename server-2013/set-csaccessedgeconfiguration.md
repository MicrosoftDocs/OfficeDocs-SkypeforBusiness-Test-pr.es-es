...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413017(v=OCS.15)
ms:contentKeyID: 48277149
ms.date: 01/07/2017
...
Modifies the property values of an existing collection of Access Edge configuration settings for computers running the Servidor perimetral de acceso. The Servidor perimetral de acceso running on these computers (also known as Edge servers) provides a way for users outside your internal network to communicate with users inside that internal network. Este cmdlet se presentó en Lync Server 2010.
