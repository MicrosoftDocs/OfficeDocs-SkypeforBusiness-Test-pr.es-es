...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412884(v=OCS.15)
ms:contentKeyID: 48276446
ms.date: 01/07/2017
...
Creates a new collection of configuration settings for computers running the Servicio perimetral A/V (these computers are also known as A/V Edge servers). An A/V Edge server enables internal users to share audio and video data with external users (that is, users who are not logged on to your internal network). Este cmdlet se presentó en Lync Server 2010.
