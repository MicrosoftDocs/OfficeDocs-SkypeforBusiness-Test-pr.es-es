...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425739(v=OCS.15)
ms:contentKeyID: 48274717
ms.date: 01/07/2017
...
Grants Lync Server management rights on an Active Directory organizational unit (OU). Este cmdlet se presentó en Lync Server 2010.
