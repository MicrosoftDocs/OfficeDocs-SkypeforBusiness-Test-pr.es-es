...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425772(v=OCS.15)
ms:contentKeyID: 48274773
ms.date: 01/07/2017
...
Removes an existing client policy. Among other things, client policies help determine the features of Lync that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Este cmdlet se presentó en Lync Server 2010.
