...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425834(v=OCS.15)
ms:contentKeyID: 48274893
ms.date: 01/07/2017
...
Revokes the Lync Server setup rights that have been granted on an Active Directory organizational unit (OU). Este cmdlet se presentó en Lync Server 2010.
