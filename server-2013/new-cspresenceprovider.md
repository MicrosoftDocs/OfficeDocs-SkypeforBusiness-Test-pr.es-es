...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204895(v=OCS.15)
ms:contentKeyID: 48275282
ms.date: 01/07/2017
...
Authorizes a new presence provider for use in the organization. Presence providers represent the PresenceProviders property of a collection of user services configuration settings. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **New-CsPresenceProvider** cmdlet are not available in the Panel de control de Lync Server.
