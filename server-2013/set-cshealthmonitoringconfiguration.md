...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425847(v=OCS.15)
ms:contentKeyID: 48274916
ms.date: 01/07/2017
...
Modifies an existing collection of health monitoring configuration settings. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. Este cmdlet se presentó en Lync Server 2010.
