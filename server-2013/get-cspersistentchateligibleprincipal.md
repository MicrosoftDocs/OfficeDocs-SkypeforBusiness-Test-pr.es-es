...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204891(v=OCS.15)
ms:contentKeyID: 48275280
ms.date: 01/07/2017
...
Returns the eligible principals for a Persistent Chat category or chat room. Eligible principals include allowed members or managers (for a category of chat room) as well as allowed presenters (chat room only). Este cmdlet se presentó en Lync Server 2013.
...
Panel de control de Lync Server: The functions carried out by the **Get-CsPersistentChatEligiblePrincipal** cmdlet are not available in the Panel de control de Lync Server.
