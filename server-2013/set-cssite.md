...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413023(v=OCS.15)
ms:contentKeyID: 48277162
ms.date: 01/07/2017
...
Modifies the properties for any of your Lync Server sites. Sites represent a collection of Lync Server pools and are typically designed around geographic regions. Lync Server includes two types of sites: data center sites and remote sites (branch office). Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Optional</p></td>
<td><p>System.String</p></td>
<td><p>Service location of the Servidor perimetral used to provide a bridge between your internal network and the Internet. For example: -FederationRoute &quot;EdgeServer:atl-edge-001.litwareinc.com&quot;.</p></td>
</tr>
<tr class="even">
