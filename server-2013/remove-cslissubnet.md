...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413053(v=OCS.15)
ms:contentKeyID: 48277252
ms.date: 01/07/2017
...
Removes a Location Information Server (LIS) subnet. Este cmdlet se presentó en Lync Server 2010.
