...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204949(v=OCS.15)
ms:contentKeyID: 48275434
ms.date: 01/07/2017
...
Modifies an existing collection of Persistent Chat compliance configuration settings. Persistent Chat compliance enables administrators to maintain an archive of Persistent Chat items and activities including: new messages; new events (for example, a user entering or existing a chat room); file uploads and downloads; and searches run against the chat history. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsPersistentChatComplianceConfiguration** cmdlet are not available in the Panel de control de Lync Server.
