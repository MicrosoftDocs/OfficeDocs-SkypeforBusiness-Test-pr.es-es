...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413042(v=OCS.15)
ms:contentKeyID: 48277200
ms.date: 01/07/2017
...
Enables you to modify management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. Este cmdlet se presentó en Lync Server 2010.
