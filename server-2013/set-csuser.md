...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398510(v=OCS.15)
ms:contentKeyID: 48275614
ms.date: 01/07/2017
...
Modifies Lync Server properties for an existing user account. Properties can be modified only for accounts that have been enabled for use with Lync Server. Este cmdlet se presentó en Lync Server 2010.
