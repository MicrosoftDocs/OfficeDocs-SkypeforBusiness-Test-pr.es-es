...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205055(v=OCS.15)
ms:contentKeyID: 48275901
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To remove an XMPP allowed partner using the Panel de control de Lync Server, click External User Access and then click XMPP Federated Partners. Select the partner to be removed, click Edit, and then click Delete.
