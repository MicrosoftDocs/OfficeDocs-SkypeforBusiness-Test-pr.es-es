...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413055(v=OCS.15)
ms:contentKeyID: 48277223
ms.date: 01/07/2017
...
Retrieves settings for one or more pools that contain the computers that host trusted applications. Este cmdlet se presentó en Lync Server 2010.
