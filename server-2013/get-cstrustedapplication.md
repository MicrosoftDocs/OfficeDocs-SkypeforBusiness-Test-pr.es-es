...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg399025(v=OCS.15)
ms:contentKeyID: 48276989
ms.date: 01/07/2017
...
Retrieves the settings for a trusted application. Este cmdlet se presentó en Lync Server 2010.
