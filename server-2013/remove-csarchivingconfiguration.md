...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398951(v=OCS.15)
ms:contentKeyID: 48276844
ms.date: 01/07/2017
...
Removes the specified collection of archiving settings. Archiving settings are used to enable or disable the automatic saving of instant messaging (IM) sessions, and to optionally block any instant message that cannot be archived. Este cmdlet se presentó en Lync Server 2010.
