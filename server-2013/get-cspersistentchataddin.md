...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204670(v=OCS.15)
ms:contentKeyID: 48274420
ms.date: 01/07/2017
...
Returns information about all the Persistent Chat add-ins configured for use in the organization. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To view Persistent Chat add-in information in Panel de control de Lync Server, click **Persistent Chat** and then click **Add-in**.
