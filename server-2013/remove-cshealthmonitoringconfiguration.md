...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425794(v=OCS.15)
ms:contentKeyID: 48274803
ms.date: 01/07/2017
...
Removes an existing collection of health monitoring configuration settings. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. Este cmdlet se presentó en Lync Server 2010.
