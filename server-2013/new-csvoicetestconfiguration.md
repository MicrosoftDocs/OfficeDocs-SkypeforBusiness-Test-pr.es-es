...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398961(v=OCS.15)
ms:contentKeyID: 48276872
ms.date: 01/07/2017
...
Creates a test scenario you can use to test phone numbers against specified routes and rules. Este cmdlet se presentó en Lync Server 2010.
