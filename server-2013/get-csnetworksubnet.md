...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412825(v=OCS.15)
ms:contentKeyID: 48276347
ms.date: 01/07/2017
...
Retrieves information about one or more network subnets. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the network subnet information from the local replica of the Almacén de administración central, rather than the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
