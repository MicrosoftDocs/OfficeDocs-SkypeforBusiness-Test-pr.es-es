...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425738(v=OCS.15)
ms:contentKeyID: 48274726
ms.date: 01/07/2017
...
Removes the specified collection of User Replicator configuration settings. The User Replicator periodically retrieves up-to-date user account information from Active Directory and then synchronizes the new information with the current user data stored by Lync Server. Este cmdlet se presentó en Lync Server 2010.
