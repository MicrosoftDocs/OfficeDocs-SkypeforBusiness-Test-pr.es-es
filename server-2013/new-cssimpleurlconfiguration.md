...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425813(v=OCS.15)
ms:contentKeyID: 48274843
ms.date: 01/07/2017
...
Creates a new simple URL configuration collection. Simple URLs make it easier for users to join meetings and conferences. They also make it easier for Administrators to sign in to the Panel de control de Lync Server. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for which the new Simple URL configuration settings are being created. For example:</p>
