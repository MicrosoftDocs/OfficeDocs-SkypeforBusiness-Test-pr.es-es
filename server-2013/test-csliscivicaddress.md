...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425914(v=OCS.15)
ms:contentKeyID: 48275031
ms.date: 01/07/2017
...
Tests one or more civic addresses against the Master Street Address Guide. Este cmdlet se presentó en Lync Server 2010.
