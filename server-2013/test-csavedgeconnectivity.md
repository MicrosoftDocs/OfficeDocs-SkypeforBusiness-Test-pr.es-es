...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205138(v=OCS.15)
ms:contentKeyID: 48276157
ms.date: 01/07/2017
...
Verifies connectivity through the A/V Edge server. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Test-CsAVEdgeConnectivity** cmdlet are not available in the Panel de control de Lync Server.
