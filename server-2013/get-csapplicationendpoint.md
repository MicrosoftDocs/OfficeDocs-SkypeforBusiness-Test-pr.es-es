...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398655(v=OCS.15)
ms:contentKeyID: 48275865
ms.date: 01/07/2017
...
Retrieves endpoints for the Servicio de aplicaciones. Este cmdlet se presentó en Lync Server 2010.
...
This cmdlet retrieves one or more application contacts from Servicios de dominio de Active Directory. These objects are stored in Active Directory in the Application Contacts container of the RTC service.
