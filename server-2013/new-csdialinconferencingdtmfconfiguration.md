...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425792(v=OCS.15)
ms:contentKeyID: 48274800
ms.date: 01/07/2017
...
Creates a new collection of dual-tone multifrequency (DTMF) signaling settings used for dial-in conferencing. DTMF enables users who dial in to a conference to control conference settings (such as muting and unmuting themselves or locking and unlocking the conference) by using the keypad on their telephone. Este cmdlet se presentó en Lync Server 2010.
