...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398209(v=OCS.15)
ms:contentKeyID: 48274492
ms.date: 01/07/2017
...
Removes an existing range of unassigned numbers and the routing rules that apply to those numbers. Este cmdlet se presentó en Lync Server 2010.
