...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413064(v=OCS.15)
ms:contentKeyID: 48277233
ms.date: 01/07/2017
...
Removes the specified instant message file transfer filter configuration. (Instant message file transfer filter settings are used to block a user’s ability to transfer certain types of files within an instant message.) Este cmdlet se presentó en Lync Server 2010.
