...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398365(v=OCS.15)
ms:contentKeyID: 48275295
ms.date: 01/07/2017
...
Creates a new network site for use with call admission control (CAC) or Enhanced 9-1-1 (E9-1-1). Este cmdlet se presentó en Lync Server 2010.
