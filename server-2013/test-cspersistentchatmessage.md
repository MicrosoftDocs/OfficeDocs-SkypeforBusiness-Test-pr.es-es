...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204656(v=OCS.15)
ms:contentKeyID: 48274357
ms.date: 01/07/2017
...
Verifies whether or not a pair of users can exchange messages using the Persistent Chat service (formerly known as the Group Chat service). Este cmdlet se presentó en Lync Server 2013.
...
Panel de control de Lync Server: The functions carried out by the **Test-CsPersistentChatMessage** cmdlet are not available in the Panel de control de Lync Server.
