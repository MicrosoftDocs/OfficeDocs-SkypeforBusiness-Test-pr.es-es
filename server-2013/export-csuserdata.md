...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204897(v=OCS.15)
ms:contentKeyID: 48275238
ms.date: 01/07/2017
...
Exports user data in a format that can be imported into Lync Server. The data will be exported as a .ZIP file containing a pair of XML documents. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Export-CsUserData** cmdlet are not available in the Panel de control de Lync Server.
