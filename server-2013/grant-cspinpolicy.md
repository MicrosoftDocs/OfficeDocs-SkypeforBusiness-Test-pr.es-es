...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398871(v=OCS.15)
ms:contentKeyID: 48276717
ms.date: 01/07/2017
...
Assigns a client personal identification number (PIN) policy to a user or group of users. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Este cmdlet se presentó en Lync Server 2010.
