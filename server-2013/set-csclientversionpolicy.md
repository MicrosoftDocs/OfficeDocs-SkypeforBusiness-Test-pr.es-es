...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398876(v=OCS.15)
ms:contentKeyID: 48276728
ms.date: 01/07/2017
...
Modifies an existing client version policy. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be allowed to log on to your Lync Server system. Este cmdlet se presentó en Lync Server 2010.
