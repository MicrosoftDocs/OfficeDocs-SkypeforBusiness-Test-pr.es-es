...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425857(v=OCS.15)
ms:contentKeyID: 48274929
ms.date: 01/07/2017
...
Creates a new SIP domain for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Este cmdlet se presentó en Lync Server 2010.
