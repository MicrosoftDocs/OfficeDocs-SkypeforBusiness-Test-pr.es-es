...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ619182(v=OCS.15)
ms:contentKeyID: 49115293
ms.date: 01/07/2017
...
Modifies an existing collection of centralized logging configuration settings. Centralized logging provides a way for administrators to simultaneously enable or disable tracing on multiple computers. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsClsConfiguration** cmdlet are not available in the Panel de control de Lync Server.
