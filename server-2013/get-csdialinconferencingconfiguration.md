...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398575(v=OCS.15)
ms:contentKeyID: 48275692
ms.date: 01/07/2017
...
Retrieves information about how Lync Server responds when users join or leave a dial-in conference. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the dial-in conferencing data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
