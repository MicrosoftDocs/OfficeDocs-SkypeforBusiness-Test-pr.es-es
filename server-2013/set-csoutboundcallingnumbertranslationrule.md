...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205400(v=OCS.15)
ms:contentKeyID: 48277050
ms.date: 01/07/2017
...
Modifies an existing outbound calling number translation rule. An outbound calling number translation rule converts the E.164 phone numbers used by Lync Server 2013 to a format that can be used by trunking peers that do not support E.164 numbers. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To edit an existing outbound calling number translation rule using the Panel de control de Lync Server, click Voice Routing, click Trunk Configuration, and then double-click the configuration settings containing the rule to be modified. In the Edit Trunk Configuration dialog box, scroll down to the section labeled Calling number translation rules and then double-click the rule to be modified.
