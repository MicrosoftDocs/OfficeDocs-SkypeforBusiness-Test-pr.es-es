...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398249(v=OCS.15)
ms:contentKeyID: 48274586
ms.date: 01/07/2017
...
Removes the specified collection of Lync Phone Edition configuration settings. These settings include such things as the required security mode and whether the phone should automatically be locked after a specified period of inactivity. Este cmdlet se presentó en Lync Server 2010.
