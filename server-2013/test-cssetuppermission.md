...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398428(v=OCS.15)
ms:contentKeyID: 48275439
ms.date: 01/07/2017
...
Verifies that the required permissions needed to install Lync Server or one of its components have been configured on the specified Active Directory container. Este cmdlet se presentó en Lync Server 2010.
