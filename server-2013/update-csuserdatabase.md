...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398682(v=OCS.15)
ms:contentKeyID: 48275911
ms.date: 01/07/2017
...
Forces the back-end user database to clear its replication status with Active Directory. This causes the database to re-read all the user-related information stored in Servicios de dominio de Active Directory. Este cmdlet se presentó en Lync Server 2010.
