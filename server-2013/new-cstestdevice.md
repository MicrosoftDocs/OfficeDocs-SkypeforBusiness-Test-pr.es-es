...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425899(v=OCS.15)
ms:contentKeyID: 48275013
ms.date: 01/07/2017
...
Creates a new device update management test device. Test devices provide a way for administrators to test firmware updates before those updates are distributed to all the devices in an organization. Este cmdlet se presentó en Lync Server 2010.
