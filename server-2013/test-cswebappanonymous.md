...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Hh690041(v=OCS.15)
ms:contentKeyID: 48276333
ms.date: 01/07/2017
...
Verifies that anonymous users can use the Lync Web App to join a Lync Server conference. Este cmdlet se presentó en Lync Server 2010.
