...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205388(v=OCS.15)
ms:contentKeyID: 48277187
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Grant-CsUserServicesPolicy** cmdlet are not available in the Panel de control de Lync Server.
