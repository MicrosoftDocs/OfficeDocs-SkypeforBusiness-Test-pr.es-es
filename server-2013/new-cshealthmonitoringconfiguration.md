...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398718(v=OCS.15)
ms:contentKeyID: 48275987
ms.date: 01/07/2017
...
Creates a new collection of health monitoring configuration settings for use in your organization. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. Este cmdlet se presentó en Lync Server 2010.
