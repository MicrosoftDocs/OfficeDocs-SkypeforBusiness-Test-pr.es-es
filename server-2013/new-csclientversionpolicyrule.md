...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398905(v=OCS.15)
ms:contentKeyID: 48276754
ms.date: 01/07/2017
...
Creates a new client version policy rule. Client version policy rules help determine whether users can use a specific client application to log on to Lync Server. Este cmdlet se presentó en Lync Server 2010.
