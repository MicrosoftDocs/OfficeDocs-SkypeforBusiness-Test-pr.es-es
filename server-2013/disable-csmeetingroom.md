...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204723(v=OCS.15)
ms:contentKeyID: 48274599
ms.date: 01/07/2017
...
Disables a Lync Server 2013 meeting room. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. When you disable a meeting room object you remove all the Lync Server-specific Active Directory attributes assigned to the user account that represents the meeting room. However, the Active Directory user account itself is not deleted. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Disable-CsMeetingRoom** cmdlet are not available in the Panel de control de Lync Server.
