...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412863(v=OCS.15)
ms:contentKeyID: 48276404
ms.date: 01/07/2017
...
Modifies an existing bandwidth policy service configuration. Este cmdlet se presentó en Lync Server 2010.
