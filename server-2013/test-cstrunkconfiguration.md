...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398137(v=OCS.15)
ms:contentKeyID: 48274341
ms.date: 01/07/2017
...
Validates a trunk configuration against a phone number. Este cmdlet se presentó en Lync Server 2010.
