...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398644(v=OCS.15)
ms:contentKeyID: 48275842
ms.date: 01/07/2017
...
Modifies an existing dial plan. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Permite transmitir una referencia a un objeto en el cmdlet en lugar de establecer valores de parámetro independientes. You can retrieve this object reference by calling the <strong>Get-CsDialPlan</strong> cmdlet.</p></td>
</tr>
<tr class="even">
