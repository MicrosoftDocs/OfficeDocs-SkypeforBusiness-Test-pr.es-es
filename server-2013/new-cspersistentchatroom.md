...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205166(v=OCS.15)
ms:contentKeyID: 48276365
ms.date: 01/07/2017
...
Creates a new Persistent Chat chat room. A chat room is a discussion forum that typically revolves around a specific topic. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** To create a new Persistent Chat chat room using the Panel de control de Lync Server, click **Persistent Chat**, click **Room**, and then click **New**.
