...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412922(v=OCS.15)
ms:contentKeyID: 48276513
ms.date: 01/07/2017
...
Deletes the specified Lync Server database. Este cmdlet se presentó en Lync Server 2010.
...
The command shown in Example 1 deletes the Almacén de administración central from the computer atl-sql-001.litwareinc.com.
...
Lync Server makes extensive use of SQL Server databases such as the Almacén de administración central and the Base de datos de archivado. These databases are set up at the same time you install Lync Server or at the same time you install a Lync Server role that requires a database back end. After the databases have been installed, you will rarely need to uninstall them.
...
<td><p>If present, uninstalls the Almacén de administración central. You cannot use both CentralManagementDatabase and DatabaseType in the same command.</p></td>
</tr>
<tr class="even">
...
<p>Registrar</p>
<p>User</p>
<p>To delete the Almacén de administración central, use the CentralManagementDatabase parameter.</p></td>
</tr>
<tr class="odd">
