...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412727(v=OCS.15)
ms:contentKeyID: 48276142
ms.date: 01/07/2017
...
Retrieves one or more bandwidth policy service configurations. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the bandwidth policy service configuration from the local replica of the Almacén de administración central, rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
