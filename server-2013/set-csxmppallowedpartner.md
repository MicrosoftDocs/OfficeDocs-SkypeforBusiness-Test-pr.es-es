...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204686(v=OCS.15)
ms:contentKeyID: 48274491
ms.date: 01/07/2017
...
**Panel de control de Lync Server:** To edit the property values for an existing XMPP allowed partner using the Panel de control de Lync Server, click External User Access, click XMPP Federated Partners, and then double-click the partner to be modified.
