...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205109(v=OCS.15)
ms:contentKeyID: 48276134
ms.date: 01/07/2017
...
Modifies the state of a Persistent Chat service pool. Persistent Chat pools can be in one of two states: Normal, in which the pool uses its primary databases; or FailedOver, in which the pool uses the backup databases defined in the topology. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Set-CsPersistentChatState** cmdlet are not available in the Panel de control de Lync Server.
