...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398757(v=OCS.15)
ms:contentKeyID: 48276058
ms.date: 01/07/2017
...
Creates a new location or modifies an existing location in the location configuration database for Enhanced 9-1-1 (E9-1-1). Este cmdlet se presentó en Lync Server 2010.
