...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398969(v=OCS.15)
ms:contentKeyID: 48276875
ms.date: 01/07/2017
...
Removes an existing Response Group agent group. An agent group is a collection of agents assigned to a Response Group queue. Agents are the users assigned to answer calls directed to a particular queue. Este cmdlet se presentó en Lync Server 2010.
