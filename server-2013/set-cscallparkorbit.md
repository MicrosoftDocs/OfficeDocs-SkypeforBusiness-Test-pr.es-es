...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398796(v=OCS.15)
ms:contentKeyID: 48276117
ms.date: 01/07/2017
...
Sets the properties for an existing call park orbit range within an organization. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>The fully qualified domain name (FQDN) or service ID of the Application service that hosts the Aplicación de estacionamiento de llamadas. All calls parked to numbers within the range specified by the NumberRangeStart and NumberRangeEnd parameters will be routed to this server or pool.</p>
<p></p></td>
</tr>
<tr class="even">
...
<td><p>Permite transmitir una referencia a un objeto en el cmdlet en lugar de establecer valores de parámetro independientes. This object must be of type DisplayCallParkOrbit, which can be retrieved by calling the <strong>Get-CsCallParkOrbit</strong> cmdlet.</p></td>
</tr>
<tr class="even">
