...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204739(v=OCS.15)
ms:contentKeyID: 48274634
ms.date: 04/05/2017
...
**Panel de control de Lync Server:** The functions carried out by the **Get-CsWatcherNodeConfiguration** cmdlet are not available in the Panel de control de Lync Server.
