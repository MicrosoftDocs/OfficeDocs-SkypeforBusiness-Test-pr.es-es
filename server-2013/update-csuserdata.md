...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205358(v=OCS.15)
ms:contentKeyID: 48276951
ms.date: 01/07/2017
...
Uses previously-exported user information to update Lync Server user data. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Update-CsUserData** cmdlet are not available in the Panel de control de Lync Server.
