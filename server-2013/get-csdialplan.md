...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg413043(v=OCS.15)
ms:contentKeyID: 48277231
ms.date: 01/07/2017
...
Returns information about the dial plans used in your organization. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the dial plan information from the local replica of the Almacén de administración central, rather than the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
