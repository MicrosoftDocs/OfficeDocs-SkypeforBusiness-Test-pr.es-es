...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398643(v=OCS.15)
ms:contentKeyID: 48275829
ms.date: 01/07/2017
...
Resets the routing configuration to its default settings. Este cmdlet se presentó en Lync Server 2010.
