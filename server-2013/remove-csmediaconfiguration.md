...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398705(v=OCS.15)
ms:contentKeyID: 48275944
ms.date: 01/07/2017
...
Removes the specified collection of media configuration settings. Este cmdlet se presentó en Lync Server 2010.
