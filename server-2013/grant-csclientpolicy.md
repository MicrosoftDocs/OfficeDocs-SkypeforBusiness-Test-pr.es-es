...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412942(v=OCS.15)
ms:contentKeyID: 48276545
ms.date: 01/07/2017
...
Assigns a client policy to a user or a group of users. Among other things, client policies help determine the features of Lync Server that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Este cmdlet se presentó en Lync Server 2010.
