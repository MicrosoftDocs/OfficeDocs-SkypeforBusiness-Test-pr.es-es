...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204740(v=OCS.15)
ms:contentKeyID: 48274637
ms.date: 01/07/2017
...
Verifies that the Lync Server Storage Service is working on a Servidor front-end. This is done by creating a test email message in the specified Exchange mailbox and then optionally deleting that message at the end of the text. **Test-CsExStorageConnectivity** also verifies that Exchange archiving is working as expected. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Test-CsExStorageConnectivity** cmdlet are not available in the Panel de control de Lync Server.
