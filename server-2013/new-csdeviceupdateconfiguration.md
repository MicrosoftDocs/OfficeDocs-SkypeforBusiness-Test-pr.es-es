...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425761(v=OCS.15)
ms:contentKeyID: 48274750
ms.date: 01/07/2017
...
Creates a new instance of device update configuration settings. These settings are used to manage the Servicio web de actualización de dispositivos, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Server. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Indicates the valid log file extensions that can be used with the Servicio web de actualización de dispositivos. This list can be modified; however, there is no reason to modify the list unless you have a device running Lync Server that creates log files that use a different file extension.</p>
