...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398553(v=OCS.15)
ms:contentKeyID: 48275652
ms.date: 01/07/2017
...
Removes an existing collection of proxy server configuration settings. Este cmdlet se presentó en Lync Server 2010.
