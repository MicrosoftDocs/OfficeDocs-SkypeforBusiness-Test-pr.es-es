...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412949(v=OCS.15)
ms:contentKeyID: 48276567
ms.date: 01/07/2017
...
Enables you to modify property values for the SIP domains in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Este cmdlet se presentó en Lync Server 2010.
