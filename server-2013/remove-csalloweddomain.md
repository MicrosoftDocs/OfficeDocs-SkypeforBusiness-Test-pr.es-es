...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398913(v=OCS.15)
ms:contentKeyID: 48276765
ms.date: 01/07/2017
...
Removes a domain from the list of domains approved for federation. Este cmdlet se presentó en Lync Server 2010.
