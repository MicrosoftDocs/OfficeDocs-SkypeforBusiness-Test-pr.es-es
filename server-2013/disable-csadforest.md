...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398122(v=OCS.15)
ms:contentKeyID: 48274320
ms.date: 01/07/2017
...
Undoes the forest preparation tasks carried out by the **Enable-CsAdForest** cmdlet. This cmdlet is typically used only if you are uninstalling Lync Server. Este cmdlet se presentó en Lync Server 2010.
