...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398231(v=OCS.15)
ms:contentKeyID: 48274541
ms.date: 01/07/2017
...
Creates a new location policy for use with location identification for the Enhanced 9-1-1 (E9-1-1) service and general client location. The E9-1-1 service enables those who answer 911 calls to determine the caller’s geographic location. Este cmdlet se presentó en Lync Server 2010.
