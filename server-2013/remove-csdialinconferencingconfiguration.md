...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398174(v=OCS.15)
ms:contentKeyID: 48274412
ms.date: 01/07/2017
...
Removes one or more collections of dial-in conferencing configuration settings. These settings determine how Lync Server responds when users join or leave a dial-in conference. Este cmdlet se presentó en Lync Server 2010.
