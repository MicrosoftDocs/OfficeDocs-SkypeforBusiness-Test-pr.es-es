...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398877(v=OCS.15)
ms:contentKeyID: 48276729
ms.date: 01/07/2017
...
Removes an existing bandwidth policy service configuration. Este cmdlet se presentó en Lync Server 2010.
