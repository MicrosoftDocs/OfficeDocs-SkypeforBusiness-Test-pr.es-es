...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Hh690031(v=OCS.15)
ms:contentKeyID: 48276163
ms.date: 01/07/2017
...
<td><p>Retrieves the Mobility Service configuration data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
