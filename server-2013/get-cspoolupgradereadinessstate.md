...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ204689(v=OCS.15)
ms:contentKeyID: 48274488
ms.date: 01/07/2017
...
Returns information indicating whether or not your Skype Empresarial Online Registrar pools are ready to be upgraded. The upgrade readiness state for a pool is based on the upgrade domains that have been configured for that pool. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Get-CsPoolUpgradeReadinessState** cmdlet are not available in the Panel de control de Lync Server.
