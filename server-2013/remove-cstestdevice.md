...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398790(v=OCS.15)
ms:contentKeyID: 48276106
ms.date: 01/07/2017
...
Removes the specified device update management test device. Test devices provide a way for administrators to test firmware updates before those updates are distributed to all the devices in an organization. Este cmdlet se presentó en Lync Server 2010.
