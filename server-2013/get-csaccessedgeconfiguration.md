...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg398574(v=OCS.15)
ms:contentKeyID: 48275690
ms.date: 01/07/2017
...
Returns information about the configuration settings for computers running the Servidor perimetral de acceso in your organization (also known as Access Edge servers). Access Edge servers provide a way for users outside your internal network to communicate with users inside your internal network. Este cmdlet se presentó en Lync Server 2010.
...
<td><p>Retrieves the Access Edge configuration data from the local replica of the Almacén de administración central rather than from the Almacén de administración central itself.</p></td>
</tr>
</tbody>
</table>
