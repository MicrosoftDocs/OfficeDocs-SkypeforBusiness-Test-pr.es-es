...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ205113(v=OCS.15)
ms:contentKeyID: 48276073
ms.date: 01/07/2017
...
Manually purges records from the Call Detail records (CDR) database. Este cmdlet se presentó en Lync Server 2013.
...
**Panel de control de Lync Server:** The functions carried out by the **Invoke-CsCdrDatabasePurge** cmdlet are not available in the Panel de control de Lync Server.
