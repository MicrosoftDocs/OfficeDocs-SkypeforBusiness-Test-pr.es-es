...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Hh690028(v=OCS.15)
ms:contentKeyID: 48275731
ms.date: 01/07/2017
...
<td><p>Globally unique identifier (GUID) of the Skype Empresarial Online tenant account for the push notification configuration settings being deleted. For example:</p>
