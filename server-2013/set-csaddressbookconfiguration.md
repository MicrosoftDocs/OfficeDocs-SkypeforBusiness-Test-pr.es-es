...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg412784(v=OCS.15)
ms:contentKeyID: 48276205
ms.date: 01/07/2017
...
Modifies an existing collection of Address Book configuration settings. Este cmdlet se presentó en Lync Server 2010.
