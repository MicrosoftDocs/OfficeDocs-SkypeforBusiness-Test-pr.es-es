...
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Gg425788(v=OCS.15)
ms:contentKeyID: 48274796
ms.date: 01/07/2017
...
Modifies an existing conferencing policy. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Este cmdlet se presentó en Lync Server 2010.
